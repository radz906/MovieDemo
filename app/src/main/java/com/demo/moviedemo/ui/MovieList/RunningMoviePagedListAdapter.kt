...
class RunningMoviePagedListAdapter(public val context: Context) : PagedListAdapter<MovieListData, RecyclerView.ViewHolder>(MovieDiffCallback()) {
    ...
    class MovieDiffCallback : DiffUtil.ItemCallback<MovieListData>() {
    ...
    class MovieItemViewHolder (view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(movie: MovieListData?, context: Context) {
            ...
            itemView.setOnClickListener{
                val intent = Intent(context, com.demo.moviedemo.ui.MovieDetails.MovieDetails::class.java)
